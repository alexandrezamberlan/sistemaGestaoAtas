...
Criar ou copiar .env para o servidor
...
Passo 1 - Iniciar o parser gunicorn:
sudo systemctl start nomeProjeto

Passo 2 - Adicionar o nosso sistema como serviço reconhecido no sistema operacional:
sudo systemctl enable nomeProjeto

Caso acontece problemas na geração do .sock do serviço e o .service precise ser atualizado, há necessidade de rodar:
sudo systemctl daemon-reload

E depois executa novamente passo 1 e 2


============
NGINX

Esse é o roteiro para criar outros serviços virtuais, ai e só substituir exemplo.com pelo  
domínio que você vai utilizar sem www (por exemplo, comic.labinf.ufn.edu.br)
 
...
Em vez de modificar o arquivo de configuração padrão diretamente, 
vamos criar um novo em /etc/nginx/sites-available/examplo.com:
 
...
=============================
No settings.py do caminho urlProjeto/nomeProjeto/projeto/projeto, adicionar à variável de ambiente (EXEMPLO)

ALLOWED_HOSTS = ['localhost','www.soga.lapinf.ufn.edu.br', 'soga.lapinf.ufn.edu.br']
=============================
 
...
OBSERVAÇÃO: jamais rodar o makemigration no servidor

rodar migrate

#via shell django -> python manage.py shell
...
=======
Adicionar no .env a variável de ambiente para setar o MySQL como o banco no servidor
DATABASE_URL=mysql://soga:soga2020@127.0.0.1:3306/soga_db
